#include "market_data_publish.h"

namespace Exchange {
    MarketDataPublisher::MarketDataPublisher(MEMarketUpdateLFQueue *market_update, const std::string &iface,
                                             const int &snapshot_ip, int snapshot_port, const int &incremental_ip,
